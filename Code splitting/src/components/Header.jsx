    ...
    return (
        <header className="flex justify-between  md:px-8 py-5 px-4 shadow-lg hover:bg-slate-100 ">
            ...
            <ul className="flex gap-5">
                ...
                <li>
                    <NavLink className={(e)=> e.isActive?"underline text-blue-800":null} to="/contact">Contact</NavLink>
                </li>
                <li>
